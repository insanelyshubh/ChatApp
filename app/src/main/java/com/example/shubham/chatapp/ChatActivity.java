...
public class ChatActivity extends AppCompatActivity {
    private final String mChannelUrl = "YOUR_CHANNEL_NAME";
    ...
    protected void onResume() {
        ...
        SendBird.addChannelHandler(CHANNEL_HANDLER_ID, new SendBird.ChannelHandler() {
            ...
            public void onUserEntered(OpenChannel channel, User user) {
                ...
                if (channel.getParticipantCount()>1)
                    showNotification("HELLO!!","Your friend is online");
    ...
    void showNotification(String title, String content) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            ...
            channel.setDescription("notification for new message");
        ...
        SendBird.addChannelHandler(CHANNEL_HANDLER_ID, new SendBird.ChannelHandler() {
            ...
            public void onMessageReceived(BaseChannel baseChannel, BaseMessage baseMessage) {
                    ...
                    if(isAppIsInBackground(getApplicationContext())) {
                        showNotification("New Message","You have new messages to see!");
                        mChatAdapter.appendMessage((UserMessage) baseMessage);
